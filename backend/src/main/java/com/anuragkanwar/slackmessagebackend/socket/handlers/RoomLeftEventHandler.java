...
@Slf4j
@Component
public class RoomLeftEventHandler implements EventHandler<RoomDto> {

    private final SocketIOServer socketServer;
    private final SocketRoomManager roomManager;

    public RoomLeftEventHandler(SocketIOServer socketServer, SocketRoomManager roomManager) {
