...
@Slf4j
@Component
public class RoomRenameEventHandler implements EventHandler<RoomDto> {

    private final SocketIOServer socketServer;
    private final SocketRoomManager roomManager;

    public RoomRenameEventHandler(SocketIOServer socketServer, SocketRoomManager roomManager) {
