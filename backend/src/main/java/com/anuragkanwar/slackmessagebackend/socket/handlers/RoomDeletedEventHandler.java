...
@Slf4j
@Component
public class RoomDeletedEventHandler implements EventHandler<RoomDto> {

    private final SocketIOServer socketServer;
    private final SocketRoomManager roomManager;

    public RoomDeletedEventHandler(SocketIOServer socketServer, SocketRoomManager roomManager) {
