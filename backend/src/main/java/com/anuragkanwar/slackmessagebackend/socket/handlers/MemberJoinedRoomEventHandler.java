...
@Slf4j
@Component
public class MemberJoinedRoomEventHandler implements EventHandler<MemberJoinedResponseDto> {

    private final SocketIOServer socketServer;
    private final SocketRoomManager roomManager;

    public MemberJoinedRoomEventHandler(SocketIOServer socketServer, SocketRoomManager roomManager) {
        this.socketServer = socketServer;
        this.roomManager = roomManager;
    }

    @Override
    public void handleEvent(BaseEvent<MemberJoinedResponseDto> event) {
