...
@Component
public class UserLeftWorkspaceEventHandler implements EventHandler<UserDto> {
    private final SocketIOServer socketServer;
    private final SocketRoomManager roomManager;

    public UserLeftWorkspaceEventHandler(SocketIOServer socketServer, SocketRoomManager roomManager) {
    ...
    public SocketEvent getSupportedEventType() {
        return SocketEvent.user_left_workspace;
    }
}
